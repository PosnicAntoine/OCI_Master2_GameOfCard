class Card{
    ...
    carteToHtml(){
        ...
        switch(parseInt(this.value)){
            ...
            case 11 : ret = '<section class="card card--'+ this.color +'" value="J"><div class="card__inner card__inner--centered"><div class="card__column"><div class="king"></div></div></div></section> '; break;
            case 12 : ret = '<section class="card card--'+ this.color +'" value="Q"><div class="card__inner card__inner--centered"><div class="card__column"><div class="king"></div></div></div></section> '; break;
